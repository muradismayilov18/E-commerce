...
const WeeklyDeal = () => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-xl max-w-6xl mx-auto my-16 p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="md:w-1/2">
                    <img 
                        src="https://res.cloudinary.com/dwdvr0oxa/image/upload/v1738912649/1_wrkm4r.jpg" 
                        alt="Monitor Deal" 
                        className="rounded-lg shadow-xl w-full max-w-md mx-auto h-auto object-cover"
                    />
                </div>
            </div>
        </div>
